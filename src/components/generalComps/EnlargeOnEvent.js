...
export const EnlargeOnEvent = React.forwardRef(
  (
    ...
    useOnClickOutside(ref, () =>
      shrinkOnClickOutside ? setenlarge(false) : undefined
    );
      ...
      <div
        ...
        style={{
          ...
          height: useOnHeight
            ...
            : undefined,
          overflow:
            allowOverflowOnEnlarge && (value === true || enlarge)
              ? "visible"
              : "hidden",
          position: style?.position ?? "relative",
          background:
            value === true || enlarge ? colors.gray + "40" : style?.background,
